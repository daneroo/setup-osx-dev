...
/* Hint explanations
  ...
  sloppy: true // use strict not required
  vars: true   // many var statements per function
  undef:true   // misordered definitions
  stupid: true // blocking ('...Sync') methods can be used
*/
